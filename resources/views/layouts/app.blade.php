...
@else
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <a href="#" class="nav-link active">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="{{route('categoriaskill.index')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Categoria Skills</p>
                </a>
              </li>
              <li class="nav-item">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
              <a href="{{route('nuestraexperiencia.index')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; 2020 <a href="https://goodev.dev">GooDev</a>.</strong> All rights reserved.
  </footer>
</div>
<!-- ./wrapper -->
